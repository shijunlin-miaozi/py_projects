...
# download vaccine data here: https://data.nzis.cz/news-detail/cs/48-covid-19-nove-otevrene-datove-sady-s-ohledem-na-vykazana-ockovani/
...
def plot_vac():
    ...
    for i in ax[3:]:
        for c in i.containers:
            i.bar_label(c, label_type='center', fmt = '%g')
